...
"""autogenerated by genpy from benchmarking_msgs/Grasp2DPredictionRequest.msg. Do not edit."""
import codecs
import sys
...
class Grasp2DPredictionRequest(genpy.Message):
  _md5sum = "f1c49a106a69eea7fc2688cb15ba57b6"
  _type = "benchmarking_msgs/Grasp2DPredictionRequest"
...
string frame_id
"""
  __slots__ = ['depth_image','rgb_image']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Grasp2DPredictionRequest, self).__init__(*args, **kwds)
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from benchmarking_msgs/Grasp2DPredictionResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
import benchmarking_msgs.msg

class Grasp2DPredictionResponse(genpy.Message):
  _md5sum = "54979a58058ba544cf07ee2628f9dd58"
  _type = "benchmarking_msgs/Grasp2DPredictionResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
float32 quality"""
  ...
  _slot_types = ['bool','benchmarking_msgs/Grasp2D']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Grasp2DPredictionResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.success is None:
        self.success = False
      if self.best_grasp is None:
        self.best_grasp = benchmarking_msgs.msg.Grasp2D()
    else:
      self.success = False
      self.best_grasp = benchmarking_msgs.msg.Grasp2D()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B2i3f().pack(_x.success, _x.best_grasp.px, _x.best_grasp.py, _x.best_grasp.angle, _x.best_grasp.width, _x.best_grasp.quality))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.success, _x.best_grasp.px, _x.best_grasp.py, _x.best_grasp.angle, _x.best_grasp.width, _x.best_grasp.quality,) = _get_struct_B2i3f().unpack(str[start:end])
...
def _get_struct_I():
    ...
    return _struct_I
_struct_B2i3f = None
def _get_struct_B2i3f():
    global _struct_B2i3f
    if _struct_B2i3f is None:
        _struct_B2i3f = struct.Struct("<B2i3f")
    return _struct_B2i3f
class Grasp2DPrediction(object):
  _type          = 'benchmarking_msgs/Grasp2DPrediction'
  _md5sum = 'b62ec6f0334c09da4ef4d7cc361762ae'
  _request_class  = Grasp2DPredictionRequest
  _response_class = Grasp2DPredictionResponse
