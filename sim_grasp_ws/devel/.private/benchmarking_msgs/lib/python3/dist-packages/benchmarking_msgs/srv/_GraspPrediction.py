...
"""autogenerated by genpy from benchmarking_msgs/GraspPredictionRequest.msg. Do not edit."""
import codecs
import sys
...
class GraspPredictionRequest(genpy.Message):
  ...
  _type = "benchmarking_msgs/GraspPredictionRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from benchmarking_msgs/GraspPredictionResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GraspPredictionResponse(genpy.Message):
  ...
  _type = "benchmarking_msgs/GraspPredictionResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['bool','benchmarking_msgs/Grasp']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.best_grasp is None:
        self.best_grasp = benchmarking_msgs.msg.Grasp()
    else:
      self.success = False
      self.best_grasp = benchmarking_msgs.msg.Grasp()
...
class GraspPrediction(object):
  _type          = 'benchmarking_msgs/GraspPrediction'
  _md5sum = '86d7d0d5a00535c6699247df54f62820'
