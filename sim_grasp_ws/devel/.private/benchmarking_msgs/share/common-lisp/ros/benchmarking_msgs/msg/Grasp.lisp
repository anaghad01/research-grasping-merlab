...
(cl:defmethod cl:initialize-instance :after ((m <Grasp>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Grasp)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name benchmarking_msgs-msg:<Grasp> is deprecated: use benchmarking_msgs-msg:Grasp instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader benchmarking_msgs-msg:pose-val is deprecated.  Use benchmarking_msgs-msg:pose instead.")
  (pose m))
