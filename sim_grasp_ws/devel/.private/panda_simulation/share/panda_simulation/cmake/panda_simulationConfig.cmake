...
if("TRUE" STREQUAL "TRUE")
  set(panda_simulation_SOURCE_PREFIX /home/ardangle/sim_grasp_ws/src/benchmarking_vision_based_grasping/panda_simulation)
  set(panda_simulation_DEVEL_PREFIX /home/ardangle/sim_grasp_ws/devel/.private/panda_simulation)
  ...
  set(panda_simulation_INSTALL_PREFIX /home/ardangle/sim_grasp_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'panda_simulation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ardangle/sim_grasp_ws/src/benchmarking_vision_based_grasping/panda_simulation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ardangle/sim_grasp_ws/devel/.private/panda_simulation/lib;/home/ardangle/sim_grasp_ws/devel/lib;/opt/ros/noetic/lib)
